...
public class FavoriteItemBook implements Serializable {
    ...
    //factory method
    public static FavoriteItemBook fromItem(ItemBook item, String  userEmail){
        FavoriteItemBook favoriteItem = new FavoriteItemBook();
